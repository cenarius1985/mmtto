...
class solicitudes(models.Model):
    ...
    fecha = models.DateField(default=datetime.date.today, verbose_name='Recepcion SSGG')
    numeroadquisicion= models.CharField(max_length=100, blank=True, verbose_name='Numero de Adquisicion')
    ####################################################################################
    ...
    Adjuntar_Archivo = models.FileField(verbose_name='Adjuntar Archivo', upload_to='Solicitudes_SSGG_Abast', blank=True)
    ####################################################################################
