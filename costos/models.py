...
class costos(models.Model):
    ...
    fechae = models.DateField(default=datetime.date.today, verbose_name='Fecha Emision')
    ...
    criticorelevante= models.CharField(max_length=10,choices=tipo, blank=True, verbose_name='Critico/Relevante')
    tipo = (
    ...
    serviciosolicita= models.CharField(max_length=50,choices=tipo, blank=True, verbose_name='Servicio que Solicita')
    numerofactura= models.CharField(max_length=10, verbose_name='Numero de Factura')
    ####################################################################################
    tipo = (('Convernio Marco','CONVENIO MARCO'),('Licitacion Publica','LICITACION PUBLICA'),('Trato Directo','TRATO DIRECTO'))
    convenio= models.CharField(max_length=20,choices=tipo, blank=True, verbose_name='Tipo de Convenio')
    ####################################################################################
    numerolicitacion= models.CharField(max_length=100, verbose_name='Numero de Licitacion')
    numeroordencompra= models.CharField(max_length=100, verbose_name='Numero de Orden de Compra')
    ####################################################################################
    monto=models.IntegerField(verbose_name='Valor Total')
    observaciones=models.TextField(verbose_name='Observaciones')
    ####################################################################################
    mp = (('MP','MANTENIMIENTO PREVENTIVO'),('MC','MANTENIMIENTO CORRECTIVO'))
    mantenimiento= models.CharField(max_length=10,choices=mp, blank=True, verbose_name='Tipo de Mantenimiento')
    ...
    def __str__ (self):
        return "{0} ({1})".format(self.numerofactura, self.proveedor )

    class Meta:
        verbose_name='Costos de Mantenimiento Equipos Medicos e Industriales'
        ordering = ['-id']