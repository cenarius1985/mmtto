...
class actas(models.Model):	
    ...
    Proveedor= models.CharField(max_length=50, blank=True, verbose_name='Empresa o Proveedor')
    Guia= models.CharField(max_length=50, blank=True, verbose_name='Numero de Guia de Despacho')
    OC= models.CharField(max_length=50, blank=True, verbose_name='Numero de Orden Compra')
    Licitacion= models.CharField(max_length=50, blank=True, verbose_name='Numero de Licitacion')
    Detalle = models.TextField(verbose_name='Descripcion')
    created = models.DateTimeField(auto_now_add=True, verbose_name="Fecha de creación")
    updated = models.DateTimeField(auto_now=True, verbose_name="Fecha de edición")
    Adjuntar_Archivo = models.FileField(verbose_name='Adjuntar Archivo', upload_to='Actas', blank=True)
    
    def __str__ (self):
        return "{0} ({1})".format(self.serviciosolicita, self.Proveedor)

    class Meta:
        verbose_name='Kilos Por Servicio'
        ordering = ['-id']