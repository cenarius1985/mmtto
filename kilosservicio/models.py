...
class kilosservicio(models.Model):	
    ...
    tipo = (
        ...
        ('644','644-TRANSPORTE GENERAL'),('713','713-TRABAJO SOCIAL'),('670','670-ADMINISTRACIÓN'),('567','567-REHABILITACIÓN'),('662','662-ESTERILIZACIÓN'),('888','888-PENSIONADO'),
    ...
    def __str__ (self):
        return "{0} ({1})".format(self.serviciosolicita, self.Cantidad)
